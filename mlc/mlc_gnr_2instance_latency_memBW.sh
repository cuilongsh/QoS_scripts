...
##GNR SNC3
LP_CORES="40-59,280-299"
HP_CORES="60-79,300-319"

MLC_LP_CORES=40-58,280-298
LP_LATENCY_CORE=59

MLC_HP_CORES=60-78,300-318
HP_LATENCY_CORE=79
...
#for GNR
wrmsr -p $LP_LATENCY_CORE 0x1a4 0x1ef
wrmsr -p $HP_LATENCY_CORE 0x1a4 0x1ef

wrmsr -p 299 0x1a4 0x1ef
wrmsr -p 319 0x1a4 0x1ef
